...
#   finding DevStudio (through the register)
...
if NATIVE_WIN64:
    ...
    # the corresponding register branch, if we're running a
...
class Reg:
    """Helper class to read values from the register"""
    ...
    def read_values(cls, base, key):
        """Return dict of register keys and values.
...
def find_vcvarsall(version):
    ...
    At first it tries to find the productdir of VS 2008 in the register. If
    ...
    try:
        ...
        log.debug("Unable to find productdir in register")
        productdir = None
...
class MSVCCompiler(CCompiler):
    ...
    # Helper methods for using the MSVC register settings

    def find_exe(self, exe):
        """Return path to an MSVC executable program.

        Tries to find the program in several places: first, one of the
        MSVC program search paths from the register; next, the directories
