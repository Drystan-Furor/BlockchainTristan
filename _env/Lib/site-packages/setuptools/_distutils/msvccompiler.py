...
try:
    ...
    try:
        ...
        log.info(
            "Warning: Can't read register to find the "
...
class MSVCCompiler(CCompiler):
    ...
    def get_msvc_paths(self, path, platform='x86'):
        ...
        access the register or appropriate register keys not found.
        """
        ...
        for base in HKEYS:
            ...
            if d:
                if self.__version >= 7:
                    ...
                    return d[path].split(";")
        # MSVC 6 seems to create the register entries we need only when
        # the GUI is run.
        if self.__version == 6:
            for base in HKEYS:
                if read_values(base, r"%s\6.0" % self.__root) is not None:
                    self.warn(
                        ...
                        "but the expected register settings are not present.\n"
